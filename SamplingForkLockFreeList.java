...
// Implementation of SamplingForkScan Lock-Free List
class SamplingForkLockFreeList implements Runnable {
    ...
    // ConcurrentLinkedQueue is used as a thread-safe lock-free list implementation
    ...
    public static void reset() {
        ...
        // Clear the queue to remove all elements and start fresh
        queue.clear();
    }
    ...
    public static void main(String[] args) {
        ...
        // Create an instance of SamplingForkLockFreeList with N threads
        ...
        // Initialize each thread with the instance of SamplingForkLockFreeList
        for (int i = 0; i < N; i++) {
    ...
    @Override
    public void run() {
        // Each thread performs NUM_ITERATIONS insert and delete operations on the Lock-Free List
        for (int i = 0; i < NUM_ITERATIONS; i++) {
            ...
            // Insert the object into the Lock-Free List (queue) in a lock-free manner
            queue.add(obj);

            // Mark the object for memory reclamation
            forkScan.retire(obj);

            // Remove the object from the Lock-Free List (queue) in a lock-free manner
            queue.remove(obj);
